	   ...
	   private LocationClient mLocClient;
		...
		public void onCreate(Bundle savedInstanceState) {
	        ...
	        password = preferences.getString("password", "");  
	         inputStr = preferences.getString("number", "");  
		...
		public void initData() {
			...
			Log.i("wanghe","this device id is "+InstallationId);
			...
			AVUser.logInInBackground(username+"_child", password, new LogInCallback<AVUser>() {
				...
				public void done(AVUser arg0, AVException arg1) {
					...
					if(arg1==null&&arg0!=null){
						...
						Log.i("wanghe","存储installationid "+InstallationId);
